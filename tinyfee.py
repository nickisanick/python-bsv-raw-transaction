...
#bch block explorer:
# https://explorer.bitcoin.com/bch/address/1Zh4xTzXxSevNuo8XiqdGtWhXbYxT9WPR

# Broadcast raw transaction
# https://bitcoincash.blockexplorer.com/tx/send

# Bob_addr = "1BcWYCqZEgqvgbUDzpCVpGCKARTGWdbGmj"
# Bob_addr = "1NWzVg38ggPoVGAG2VWt6ktdWMaV6S1pJK"
Bob_priv_key = "L1U93zrZyu4qM8zdwP7evR1qn52sfFXDsnx9GzdG5RWmCGi8DqtP"
Bob_addr = "1Zh4xTzXxSevNuo8XiqdGtWhXbYxT9WPR"
print( base58.b58decode_check(Bob_addr).encode("hex"))

sys.exit(0)
bob_hashed_pubkey = base58.b58decode_check(Bob_addr)[1:].encode("hex")

Bob_private_key = "L1U93zrZyu4qM8zdwP7evR1qn52sfFXDsnx9GzdG5RWmCGi8DqtP"
